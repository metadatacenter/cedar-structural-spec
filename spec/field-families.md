...
| Integer | [`IntegerField`](grammar.html#prod-IntegerField) | [`IntegerFieldSpec`](grammar.html#prod-IntegerFieldSpec) | [`IntegerValue`](grammar.html#prod-IntegerValue) | [`EmbeddedIntegerField`](grammar.html#prod-EmbeddedIntegerField) | [`05`–`06`](normative-tests/valid/05-integer-template.json), [`50`](normative-tests/valid/50-integer-field.json) |
| Decimal | [`DecimalField`](grammar.html#prod-DecimalField) | [`DecimalFieldSpec`](grammar.html#prod-DecimalFieldSpec) | [`DecimalValue`](grammar.html#prod-DecimalValue) | [`EmbeddedDecimalField`](grammar.html#prod-EmbeddedDecimalField) | [`07`–`08`](normative-tests/valid/07-decimal-template.json), [`51`](normative-tests/valid/51-decimal-field.json) |
| Float | [`FloatField`](grammar.html#prod-FloatField) | [`FloatFieldSpec`](grammar.html#prod-FloatFieldSpec) | [`FloatValue`](grammar.html#prod-FloatValue) | [`EmbeddedFloatField`](grammar.html#prod-EmbeddedFloatField) | [`108`–`109`](normative-tests/valid/108-float-template.json), [`110`](normative-tests/valid/110-float-field.json) |
| Double | [`DoubleField`](grammar.html#prod-DoubleField) | [`DoubleFieldSpec`](grammar.html#prod-DoubleFieldSpec) | [`DoubleValue`](grammar.html#prod-DoubleValue) | [`EmbeddedDoubleField`](grammar.html#prod-EmbeddedDoubleField) | [`09`–`10`](normative-tests/valid/09-double-template.json), [`52`](normative-tests/valid/52-double-field.json) |
