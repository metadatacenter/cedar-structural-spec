...
Semantic distinctions such as single-choice versus multiple-choice, date versus time versus date-time, and permitted time precision belong in `FieldType`. Purely presentational distinctions such as single-line versus multi-line text entry and 12-hour versus 24-hour time display belong in typed rendering hints.
